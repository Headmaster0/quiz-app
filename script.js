// Banque de questions : 10 questions par catégorie / domaine
const questionBank = {
  // --- STRUCTURE DE LA LANGUE (GRAMMAIRE & VOCABULAIRE) ---
  'GRAMMAR': [
    {
      text: 'Choisissez la forme correcte : \'Demain, ils ___ leurs documents à la préfecture.\'',
      options: ['déposeront', 'déposaient', 'ont déposé', 'déposer'],
      correctIndex: 0
    },
    {
      text: 'Trouvez le synonyme du mot \'Obligatoire\' :',
      options: ['Imposé', 'Facultatif', 'Interdit', 'Optionnel'],
      correctIndex: 0
    },
    {
      text: 'Complétez la phrase : \'Bien qu\'elle ___ fatiguée, elle continue ses démarches.\'',
      options: ['soit', 'est', 'était', 'sera'],
      correctIndex: 0
    },
    {
      text: 'Quel est le contraire de \'Augmenter\' ?',
      options: ['Diminuer', 'Multiplier', 'Ajouter', 'Élever'],
      correctIndex: 0
    },
    {
      text: 'Choisissez le pronom relatif correct : \'Le dossier ___ je vous ai parlé est validé.\'',
      options: ['dont', 'que', 'qui', 'où'],
      correctIndex: 0
    },
    {
      text: 'Complétez : \'Si nous avions reçu l\'accord plus tôt, nous ___ ce stage.\'',
      options: ['aurions commencé', 'commençons', 'commencerons', 'commencions'],
      correctIndex: 0
    },
    {
      text: 'Trouvez l\'orthographe correcte :',
      options: ['Administration', 'Administrasion', 'Adminisstracion', 'Adminitration'],
      correctIndex: 0
    },
    {
      text: 'Complétez : \'Elle s\'est inscrite à la formation ___ améliorer son niveau.\'',
      options: ['afin d\'', 'parce qu\'', 'comme', 'car'],
      correctIndex: 0
    },
    {
      text: 'Quel est le pluriel de \'Un journal\' ?',
      options: ['Des journaux', 'Des journals', 'Des journauxs', 'Des journales'],
      correctIndex: 0
    },
    {
      text: 'Complétez : \'Il faut que vous ___ présents à 9h00 précises.\'',
      options: ['soyez', 'êtes', 'seriez', 'étiez'],
      correctIndex: 0
    }
  ],
  ...
  'READING': [
    {
      text: 'Texte : \'Horaires du guichet : Lundi au Vendredi de 8h30 à 12h00. Fermé l\'après-midi.\' Que comprendrez-vous ?',
      options: [
        'Le guichet est fermé l\'après-midi',
        'Le guichet est ouvert le samedi matin',
        'Le guichet ouvre toute la journée',
        'Le guichet est réservé aux urgences'
      ],
      correctIndex: 0
    },
    {
      text: 'Texte : \'Pensez à vous munir de deux pièces d\'identité originales.\' Que signifie cette consigne ?',
      options: [
        'Apporter 2 documents d\'identité originaux (pas de copies)',
        'Envoyer 2 photocopies par courrier',
        'Présenter 1 seul document',
        'Ne rien apporter de particulier'
      ],
      correctIndex: 0
    },
    {
      text: 'Texte : \'Toute demande incomplète sera automatiquement rejetée.\' Que faut-il faire ?',
      options: [
        'Fournir l\'intégralité des pièces demandées',
        'Envoyer seulement la moitié du dossier',
        'Payer des frais supplémentaires',
        'Attendre une relance téléphonique'
      ],
      correctIndex: 0
    },
    {
      text: 'Texte : \'Accès interdit sans badge d\'identification.\' Que signifie ce panneau ?',
      options: [
        'Seules les personnes ayant un badge peuvent entrer',
    ...
    {
      text: 'Texte : \'En cas de changement d\'adresse, signalez-le sous 30 jours.\' Que devez-vous faire ?',
      options: [
        'Informer l\'organisme dans un délai maximum d\'un mois',
        'Changer immédiatement d\'appartement',
        'Ne rien déclarer avant la fin d\'année',
        'Rendre sa carte de séjour'
      ],
      correctIndex: 0
    },
    {
      text: 'Texte : \'Prenez rang au guichet n°4 dès le signal sonore.\' Que devez-vous faire ?',
      options: [
        'Attendre le signal sonore avant d\'aller au guichet 4',
        'Aller immédiatement au guichet 1',
        'Appeler un conseiller au téléphone',
        'Reprendre un nouveau ticket'
      ],
      correctIndex: 0
    },
    {
      text: 'Texte : \'Seules les convocations papier sont acceptées à l\'entrée.\' Que faut-il présenter ?',
      options: [
        'Un document imprimé',
        'Un SMS sur téléphone',
        'Une carte bancaire',
    ...
    {
      text: 'Texte : \'Merci de maintenir le calme dans la salle d\'attente.\' Que demande ce message ?',
      options: [
        'Ne pas faire de bruit',
        'Attendre dehors',
        'Ne pas utiliser de stylos',
        'Éteindre les lumières'
      ],
      correctIndex: 0
    },
    {
      text: 'Texte : \'Paiement uniquement par carte bancaire.\' Que pouvez-vous utiliser ?',
      options: [
        'Une carte bancaire (pas d\'espèces)',
    ...
    {
      text: 'Texte : \'Rendez-vous annulé en cas de retard supérieur à 15 minutes.\' Que risque un retardataire ?',
      options: [
        'Perdre son rendez-vous',
        'Payer une amende',
        'Attendre 5 minutes de plus',
        'Repasser le lendemain sans convocation'
      ],
      correctIndex: 0
    }
  ],
  ...
  'CIVIC_SKILL': [
    {
      text: 'Quel principe garantit la neutralité de l\'État vis-à-vis de toutes les religions ?',
      options: ['La laïcité', 'La souveraineté', 'La fraternité', 'La décentralisation'],
      correctIndex: 0
    },
    {
      text: '[Mise en situation] Vous recevez un courrier de la CAF demandant une pièce justificative. Que devez-vous faire ?',
      options: [
        'Répondre dans les délais en envoyant le document réclamé',
        'Ignorer la lettre',
        'Attendre 6 mois',
    ...
    {
      text: 'Quel est le rôle principal du Maire dans une commune ?',
      options: [
        'Administrer la commune et gérer l\'état civil',
        'Voter les lois nationales',
        'Diriger l\'armée',
        'Fixer les impôts nationaux'
      ],
      correctIndex: 0
    },
    {
      text: '[Mise en situation] Vous cherchez un logement et l\'agence refuse votre dossier à cause de votre origine. Que dit la loi ?',
      options: [
        'La discrimination est strictement interdite et punie par la loi',
        'L\'agence a le droit de choisir selon l\'origine',
        'C\'est une simple règle interne légale',
        'Il faut payer une taxe supplémentaire'
      ],
      correctIndex: 0
    },
    {
      text: 'En France, jusqu\'à quel âge l\'instruction est-elle obligatoire ?',
      options: ['16 ans', '12 ans', '18 ans', '21 ans'],
      correctIndex: 0
    },
    {
      text: '[Mise en situation] Vous êtes malade et ne pouvez pas vous rendre au travail. Quel document devez-vous envoyer à l\'employeur sous 48h ?',
      options: [
        'Un avis d\'arrêt de travail établi par un médecin',
        'Une simple lettre manuscrite sans certificat',
    ...
    {
      text: 'Quels sont les trois symboles de la République française ?',
      options: [
        'Le drapeau tricolore, la Marseillaise et Marianne',
        'Le coq, la Tour Eiffel et le Louvre',
        'L\'arc de triomphe, la devise et le blason',
        'La couronne, le sceau et le drapeau'
      ],
      correctIndex: 0
    },
    {
      text: '[Mise en situation] Vous êtes témoin d\'un accident de la circulation grave. Quel numéro gratuit contacter en priorité ?',
      options: ['Le 112 (Numéro d\'urgence européen)', 'Le 3615', 'Le 118 218', 'Le numéro de la mairie'],
      correctIndex: 0
    },
    {
      text: 'Qui vote le budget et les lois en France ?',
      options: [
    ...
    {
      text: '[Mise en situation] En tant que citoyen résident en France, respecter les lois de la République est :',
      options: [
        'Une obligation légale pour tous',
        'Une option facultative',
        'Réservé uniquement aux personnes nées en France',
        'Obligatoire seulement le week-end'
      ],
      correctIndex: 0
    }
  ],
  ...
  'CSP': [
    ...
    {
      text: '[Mise en situation] La préfecture vous demande un justificatif de domicile. Quel document pouvez-vous fournir ?',
      options: [
        'Une facture d\'électricité de moins de 6 mois',
        'Une carte bancaire',
        'Un diplôme',
        'Une fiche de paie d\'il y a 2 ans'
      ],
      correctIndex: 0
    },
    {
      text: 'En France, à quel âge l\'instruction est-elle obligatoire pour tous les enfants ?',
      options: ['3 ans', '6 ans', '10 ans', '16 ans'],
      correctIndex: 0
    },
    {
      text: '[Mise en situation] Vous êtes malade et ne pouvez pas aller travailler. Que devez-vous faire sous 48h ?',
      options: [
        'Envoyer un arrêt de travail à l\'employeur et à la CPAM',
        'Attendre de guérir avant d\'avertir la société',
        'Rendre visite à la mairie',
        'Poster un message sur les réseaux sociaux'
      ],
      correctIndex: 0
    },
    {
      text: 'L\'expression : \'Demain, ils ___ le nouveau formulaire en ligne.\'',
      options: ['rempliront', 'remplissaient', 'ont rempli', 'remplir'],
      correctIndex: 0
    },
    {
      text: 'Quel est le symbole républicain qui représente la République française ?',
      options: ['Marianne', 'Jeanne d\'Arc', 'La Joconde', 'Marie Curie'],
      correctIndex: 0
    },
    {
      text: '[Mise en situation] Votre propriétaire souhaite augmenter le loyer sans motif légal en cours de bail. Que pouvez-vous faire ?',
      options: [
        'Consulter l\'ADIL ou une association de consommateurs',
        'Arrêter immédiatement de payer',
    ...
    {
      text: 'Trouvez le synonyme du mot \'Demander\' :',
      options: ['Solliciter', 'Refuser', 'Exiger', 'Abandonner'],
      correctIndex: 0
    },
    {
      text: 'Quels sont les trois couleurs du drapeau français ?',
      options: ['Bleu, Blanc, Rouge', 'Vert, Blanc, Rouge', 'Bleu, Jaune, Rouge', 'Rouge, Blanc, Noir'],
      correctIndex: 0
    },
    {
      text: '[Mise en situation] Si vous changez d\'adresse postale, dans quel délai devez-vous le déclarer à l\'administration ?',
      options: [
        'Dans un délai de 3 mois',
        'Ce n\'est pas obligatoire',
        'Après 2 ans',
        'Uniquement au renouvellement du titre'
      ],
      correctIndex: 0
    }
  ],
  ...
  'CR': [
    {
      text: 'Quel principe garantit la séparation des religions et de la puissance publique en France ?',
      options: ['La laïcité', 'La souveraineté', 'La république', 'La décentralisation'],
      correctIndex: 0
    },
    {
      text: '[Mise en situation] Un employeur refuse de vous embaucher en raison de votre origine. Comment qualifie-t-on cet acte ?',
      options: [
        'Une discrimination (délit puni par la loi)',
        'Une liberté de choix du recruteur',
    ...
    {
      text: 'Combien de départements compte la France métropolitaine et d\'outre-mer au total ?',
      options: ['101', '95', '50', '120'],
      correctIndex: 0
    },
    {
      text: 'Choisissez la forme correcte : \'Bien qu\'il ___ tard, nous terminons la démarche.\'',
      options: ['soit', 'est', 'était', 'sera'],
      correctIndex: 0
    },
    {
      text: '[Mise en situation] En cas de litige impayé avec un commerçant, vers quelle instance gratuite de médiation s\'adresser ?',
      options: [
    ...
    {
      text: 'Qui élit les députés à l\'Assemblée nationale ?',
      options: [
    ...
    {
      text: 'Quel texte fondamental a été adopté en 1789 en France ?',
      options: [
    ...
    {
      text: 'Complétez : \'Si nous avions eu le choix, nous ___ plus tôt.\'',
      options: ['serions partis', 'partons', 'partions', 'partiriez'],
      correctIndex: 0
    },
    {
      text: '[Mise en situation] Vous êtes témoin d\'un accident grave sur la route. Quel est le numéro d\'urgence européen à composer ?',
      options: ['112', '118', '3615', '1014'],
      correctIndex: 0
    },
    {
  ...
  'NAT': [
    {
      text: 'En quelle année la loi sur la séparation des Églises et de l\'État a-t-elle été votée ?',
      options: ['1905', '1789', '1848', '1958'],
      correctIndex: 0
    },
    {
      text: 'Qui a fondé la Vème République en 1958 ?',
      options: ['Charles de Gaulle', 'François Mitterrand', 'Georges Pompidou', 'Jean Jaurès'],
      correctIndex: 0
    },
    {
      text: '[Mise en situation] En tant que citoyen français, le droit de vote aux élections est :',
      options: [
        'Un droit et un devoir civique',
        'Obligatoire sous peine d\'amende',
        'Interdit aux salariés',
        'Réservé aux plus de 25 ans'
      ],
      correctIndex: 0
    },
    {
      text: 'Quel événement marquant est célébré lors de la Fête Nationale du 14 juillet ?',
      options: [
    ...
    {
      text: 'Complétez : \'Il convient que tout citoyen ___ aux règles républicaines.\'',
      options: ['se conforme', 'conforme', 's\'est conformé', 'se conformera'],
      correctIndex: 0
    },
    {
      text: 'Où siège le Sénat en France ?',
      options: ['Au Palais du Luxembourg', 'Au Palais Bourbon', 'À l\'Élysée', 'À l\'Hôtel de Ville'],
      correctIndex: 0
    },
    {
      text: '[Mise en situation] Vous êtes convoqué comme juré d\'assises. Quelle est votre obligation ?',
      options: [
        'Siéger est un devoir citoyen obligatoire (sauf motif grave)',
        'Vous pouvez refuser sans justificatif',
        'Vous devez payer une taxe',
        'Seuls les avocats ont l\'obligation d\'y aller'
      ],
      correctIndex: 0
    },
    {
      text: 'Quel grand scientifique français a mis au point le vaccin contre la rage ?',
      options: ['Louis Pasteur', 'Marie Curie', 'Claude Bernard', 'Antoine Lavoisier'],
      correctIndex: 0
    },
    {
      text: 'Quel est l\'hymne national français ?',
      options: ['La Marseillaise', 'Le Chant des Partisans', 'L\'Hymne à la Joie', 'La Parisienne'],
      correctIndex: 0
    },
    {
      text: 'Quel organe vérifie la conformité des lois avec la Constitution ?',
      options: [
        'Le Conseil constitutionnel',
...
// Étape 2 : Sélection du parcours et préparation des questions mélangées
function selectLevel(target) {
  ...
  activeQuestions = rawQuestions.map(q => {
    const correctAnswerText = q.options[q.correctIndex || 0];
...
function showResults() {
  ...
  document.getElementById('level-text').innerHTML = `<strong>Résultat :</strong> ${
